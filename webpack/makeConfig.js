...
var devtools = 'inline-source-map'
...
export default function makeConfig(isDevelopment) {
    ...
    module: {
      loaders: [{
        ...
        query: {
          ...
          presets: ['es2015', 'react', 'stage-1'].concat(process.env.env === 'development' ? ['react-hmre'] : []),
        }
  ...
  if (process.env.env == null) {
    throw new Error('hey, what about specifying some env! (development / production)')
  }
  return config;
